...
import { Help } from '../shared/ui-kit/FormItem/FormItem';
...
export const isNotDefinedDate = (date?: Dayjs): boolean => !date?.isValid();
...
export const isConfirmPassword = (password: string, confirmPassword: string): boolean => password === confirmPassword;
